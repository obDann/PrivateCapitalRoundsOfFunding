...
boxplot by situation

```{r}
out_liar = og_data %>% filter(raised_amount_usd < 100000000)
ggplot(out_liar, aes(x = situation, y = raised_amount_usd)) + geom_boxplot()
```

Graced and crowdfunding seem similar

Late Game Safety and Publicity

Transitionary funding and liquidity coverage
